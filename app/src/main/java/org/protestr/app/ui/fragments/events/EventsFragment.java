...
import org.protestr.app.ui.UpdatePool;
import org.protestr.app.ui.activities.event_info.EventInfoActivity;
import org.protestr.app.ui.adapters.EventAdapter;
...
public class EventsFragment extends BaseFragment implements EventsFragmentView, EventAdapter.OnEventClickedListener {
    ...
    @BindView(org.protestr.app.R.id.events_recyclerview)
    RecyclerView eventsRecyclerView;
    @BindView(org.protestr.app.R.id.swipe_container)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return super.onCreateView(inflater, org.protestr.app.R.layout.fragment_events, container, savedInstanceState);
    }
    ...
    public void populateNewEventList(ArrayList<Event> newEvents) {
        ...
        if (newEvents != null && newEvents.size() != 0) {
            ...
            if (eventsRecyclerView.getAdapter().getItemCount() > 0)
                Toasty.info(getContext(), getString(org.protestr.app.R.string.no_more_events_toast)).show();
        }
    }
    ...
    public void showError() {
        swipeRefreshLayout.setRefreshing(false);
        Toasty.error(getContext(), getString(org.protestr.app.R.string.error_loading_events)).show();
    }
    ...
    public void setFirstMenuItemChecked(Menu menu) {
        ...
        switch (order) {
            case Constants.ORDER_CREATION_DATE_ASC:
                menu.findItem(org.protestr.app.R.id.sort_by_oldest).setChecked(true);
                break;
            case Constants.ORDER_CREATION_DATE_DESC:
                menu.findItem(org.protestr.app.R.id.sort_by_newest).setChecked(true);
                break;
            case Constants.ORDER_DISTANCE_ASC:
                menu.findItem(org.protestr.app.R.id.sort_by_distance_asc).setChecked(true);
                break;
            case Constants.ORDER_FROM_PARTICIPANTS_DESC:
                menu.findItem(org.protestr.app.R.id.sort_by_participants).setChecked(true);
                break;
        }
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(org.protestr.app.R.menu.menu_events, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case org.protestr.app.R.id.sort_by_newest:
                order = Constants.ORDER_CREATION_DATE_DESC;
                break;
            case org.protestr.app.R.id.sort_by_oldest:
                order = Constants.ORDER_CREATION_DATE_ASC;
                break;
            case org.protestr.app.R.id.sort_by_distance_asc:
                order = Constants.ORDER_DISTANCE_ASC;
                break;
            case org.protestr.app.R.id.sort_by_participants:
