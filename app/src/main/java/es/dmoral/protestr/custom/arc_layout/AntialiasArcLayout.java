package es.dmoral.protestr.custom.arc_layout;
...
public class AntialiasArcLayout extends FrameLayout {
    ...
    public AntialiasArcLayout(Context context) {
        super(context);
        init(context, null);
    }

    public AntialiasArcLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
